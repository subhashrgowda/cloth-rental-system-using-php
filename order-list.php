...
productlist.Price,(Quantity * Price * Days) As Total from productlist,cart1 where productlist.id = cart1.id";
                                         ...
                                         if (mysqli_num_rows($result) > 0)
    {
        ...
        while($row = mysqli_fetch_array($result))
        {
            ...
            echo'<td><a href="delete-order-details.php?id=' .  $row['id'] .  '"> <span class="lnr lnr-trash">Delete</span></a></td>';
